 ...
 */
namespace Baze\CredentialWorkflowControl\Controller\Account;
 ...
 */
class CreateLoginPost extends \Magento\Customer\Controller\AbstractAccount
{
    /**
    ...
    public function execute()
    {
        ...
        if ($validFormKey && $this->getRequest()->isPost()) {
            ...
            try {
                ...
                $customerCandidateDataObject->setCustomAttribute('password_change_required', '0');
        ...
        return $resultRedirect->setPath('customer/account/createlogin');
    }
    ...
    protected function populateNewCustomerDataObject(
        ...
        $inputData->setParam('firstname', $this->session->getCustomer()->getFirstname());
        $inputData->setParam('lastname', $this->session->getCustomer()->getLastname());
    ...
    protected function changeCustomerPassword($email)
    {
        ...
        $this->customerAccountManagement->changeResetPasswordLinkToken($customer, $newPasswordToken);
        
        return $this->customerAccountManagement->resetPassword($email, $newPasswordToken, $newPass);
    }
